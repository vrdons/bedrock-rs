...
use super::packet::{Packet, ID_MESSAGE_PACKET, read_bytes_u32, write_bytes_u32};
...
impl Packet for MessagePacket {
    ...
    fn read(&mut self, r: &mut dyn Read) -> Result<()> {
        self.recipient_id = r.read_u64::<LittleEndian>()?;
    ...
    fn write(&self, w: &mut dyn Write) -> Result<()> {
        w.write_u64::<LittleEndian>(self.recipient_id)?;
